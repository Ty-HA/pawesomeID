...
const clientId = "BLsAgZAaq1X0jFUxiKcWkMO9EjlA5Qb7HjVbWDdHLLHQsyovE9V9daN2ul08Sj9NxUG770uOeoKtYUS0pksWItY"; // get from https://dashboard.web3auth.io

function Web3AuthLoginXrpl() {
  ...
  const chainConfig = {
    ...
    rpcTarget: "https://api.tatum.io/v3/blockchain/node/ripple-testnet",
    wsTarget: "wss://s.altnet.rippletest.net:51233/",
    ticker: "XRP",
    tickerName: "XRPL",
    displayName: "xrpl testnest",
...
export default Web3AuthLoginXrpl;